...
const generatePcHtml = (designToken) => {
    return generatePcRoundVariable(designToken) + generatePcTextVariable(designToken)
}
...
if (!tokenPath || !outputPath) {
    console.error("Error: Please provide both the token file path and output file path.")
    console.log("Usage: node generateTheme.js ./token.json ./assets/scss/theme.scss")
    process.exit(1)
}
